			...
			//$site_logo_source = $GLOBALS['dashb_url'] . '/img/wpkit-logo_b.svg';
				...
				?>
					...
					<style>
						...
						background-color: <?php echo get_option( 'wk_admin_menu_bg' ); ?>;
						}
						...
						color: <?php echo get_option( 'wk_admin_menu_color' ); ?> !important;
						}
...
* Reemplaza admin footer */
		...
		function wpkit_admin_footer_version() {
		  ...
		  // return '<strong>' . $my_theme->get( 'Name' ) . '</strong>' . " V" . $my_theme->get( 'Version' );
			return '<strong>WPKit </strong> V 3.01';
		}
							...
							<div id="post-body-content">
								...
								<table class="form-table widefat">
							        ...
							        <tr valign="top" class="alternate">
								        ...
								        <td>
								        	<input type="color" name="wk_admin_menu_color" id="wk_admin_menu_color" value="<?php if( get_option( 'wk_admin_menu_color' ) ) : echo esc_attr( get_option('wk_admin_menu_color') ); else : echo '#1d242a'; endif; ?>"/>
											<p class="description">#1d242a</p>
								        </td>
							        </tr>							        
							        <tr valign="top" class="alternate">
